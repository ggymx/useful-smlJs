;(function($, window, document, undefined) {
    ...
    //轮播项的高度
    var _height = outerWidth >= middleWidth ? 380 : 240;
    var _slideHeight = outerWidth >= middleWidth ? 330 : 240;
    ...
    Carousel.prototype = {
        ...
        initalCarousel: function() {
            ...
            for (var i = 0; i < half_imgLen; i++) {
                ...
                if (k == 0) {
                    ...
                    // this.$aImg.eq(leftNum).attr('onfocus', null);
                    ...
                    // this.$aImg.eq(rightNum).attr('onfocus', null);
                    k++;
                } else {
                    this.$aImg.eq(leftNum).css({
            ...
            //     marginTop: -_height / 2 + 'px',
            //     opacity: '1',
            // }, 500).addClass('on').attr('onfocus', _href);
        ...
        inital: function() {
            ...
            this.$aImg.on('focus', function(ev) {
